...
resource "tencentcloudenterprise_monitor_tmp_instance" "tmpInstance" {
  instance_name       = "tf-test-tmp"
  vpc_id              = tencentcloudenterprise_vpc.vpc.id
  subnet_id           = tencentcloudenterprise_vpc_subnet.sub.id
...
resource "tencentcloudenterprise_monitor_tmp_exporter_integration" "tmpExporterIntegration" {
  instance_id = tencentcloudenterprise_monitor_tmp_instance.tmpInstance.id
...
resource "tencentcloudenterprise_monitor_tmp_exporter_integration" "tmpExporterIntegrationCloudMonitor" {
  instance_id = tencentcloudenterprise_monitor_tmp_instance.tmpInstance.id
...
resource "tencentcloudenterprise_monitor_tmp_exporter_integration" "tmpExporterIntegrationBlackbox" {
  instance_id = tencentcloudenterprise_monitor_tmp_instance.tmpInstance.id
...
resource "tencentcloudenterprise_monitor_tmp_exporter_integration" "tmpExporterIntegrationConsul" {
  instance_id = tencentcloudenterprise_monitor_tmp_instance.tmpInstance.id
...
resource "tencentcloudenterprise_monitor_tmp_exporter_integration" "tmpExporterIntegrationEs" {
  instance_id = tencentcloudenterprise_monitor_tmp_instance.tmpInstance.id
  kind        = "es-exporter"
  content = jsonencode({
...
resource "tencentcloudenterprise_monitor_tmp_exporter_integration" "tmpExporterIntegrationKafka" {
  instance_id = tencentcloudenterprise_monitor_tmp_instance.tmpInstance.id
  kind        = "kafka-exporter"
  content = jsonencode({
...
resource "tencentcloudenterprise_monitor_tmp_exporter_integration" "tmpExporterIntegrationMemcached" {
  instance_id = tencentcloudenterprise_monitor_tmp_instance.tmpInstance.id
...
resource "tencentcloudenterprise_monitor_tmp_exporter_integration" "tmpExporterIntegrationMongodb" {
  instance_id = tencentcloudenterprise_monitor_tmp_instance.tmpInstance.id
...
resource "tencentcloudenterprise_monitor_tmp_exporter_integration" "tmpExporterIntegrationMysql" {
  instance_id = tencentcloudenterprise_monitor_tmp_instance.tmpInstance.id
  kind        = "mysql-exporter"
  content = jsonencode({
    "name": "mysql-exporter",
...
resource "tencentcloudenterprise_monitor_tmp_exporter_integration" "tmpExporterIntegrationPostgres" {
  instance_id = tencentcloudenterprise_monitor_tmp_instance.tmpInstance.id
...
resource "tencentcloudenterprise_monitor_tmp_exporter_integration" "tmpExporterIntegrationRedis" {
  instance_id = tencentcloudenterprise_monitor_tmp_instance.tmpInstance.id
  kind        = "redis-exporter"
  content = jsonencode({
...
resource "tencentcloudenterprise_monitor_tmp_exporter_integration" "tmpExporterIntegrationRaw" {
  instance_id = tencentcloudenterprise_monitor_tmp_instance.tmpInstance.id
  kind        = "raw-job"
  content = jsonencode({
    "kind": "raw-job",
