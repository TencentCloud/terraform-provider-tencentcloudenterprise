...
data "tencentcloudenterprise_brc_autobackup_policies" "policies" {
  auto_backup_policy_id = "policy-xxxxx"
}

# Query BRC backups
data "tencentcloudenterprise_brc_backups" "backups" {
...
resource "tencentcloudenterprise_brc_activate_backup_service" "activate" {}

# BRC Auto Backup Policy
resource "tencentcloudenterprise_brc_auto_backup_policy" "policy" {
...
# BRC Backup Group
resource "tencentcloudenterprise_brc_backup_group" "group" {
...
# BRC Backup Disk
resource "tencentcloudenterprise_brc_backup_disk" "disk" {
  disk_id       = "disk-xxxxx"
...
# BRC Backup CFS
resource "tencentcloudenterprise_brc_backup_cfs" "cfs" {
  file_system_id = "cfs-xxxxx"
  backup_name    = "example-cfs-backup"
}

# BRC Backup Resource
resource "tencentcloudenterprise_brc_backup_resource" "resource" {
  resource_type = "CVM"
