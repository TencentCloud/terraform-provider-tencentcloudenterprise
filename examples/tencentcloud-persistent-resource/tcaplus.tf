...
resource "tencentcloudenterprise_tcaplus_cluster" "foo" {
  idl_type                 = "TDR"
...
resource "tencentcloudenterprise_tcaplus_tablegroup" "tablegroup" {
  cluster_id      = tencentcloudenterprise_tcaplus_cluster.foo.id
