...
resource "tencentcloudenterprise_vpn_connection" "example" {
  customer_gateway_id        = resource.tencentcloudenterprise_vpn_customer_gateway.example.id
  ...
  tags                       = {}
  vpc_id                     = "vpc-4owdpnwr"
  vpn_gateway_id             =  resource.tencentcloudenterprise_vpn_gateway.example.id
