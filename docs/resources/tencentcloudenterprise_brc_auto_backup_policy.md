---
subcategory: "Backup and Recovery(BRC)"
layout: "tencentcloudenterprise"
page_title: "TencentCloudEnterprise: tencentcloudenterprise_brc_auto_backup_policy"
sidebar_current: "docs-tencentcloudenterprise-resource-brc_auto_backup_policy"
description: |-
  Provides a resource to create a brc auto_backup_policy
---

# tencentcloudenterprise_brc_auto_backup_policy
...
tencentcloudenterprise_brc_auto_backup_policy can be imported using the id, e.g.
