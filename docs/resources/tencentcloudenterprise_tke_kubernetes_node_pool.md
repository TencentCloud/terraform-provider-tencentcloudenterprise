...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_tke_kubernetes_node_pool"
sidebar_current: "docs-tencentcloudenterprise-resource-tke_kubernetes_node_pool"
description: |-
  Provide a resource to create an auto scaling group for kubernetes cluster.
---

# tencentcloudenterprise_tke_kubernetes_node_pool
...
* `container_runtime` - (Optional, String, ForceNew) Runtime type of the node pool. The default value is `containerd`. Valid values are `containerd` and `docker`.
...
* `runtime_version` - (Optional, String, ForceNew) Runtime version of the node pool. If not specified, the default value will be used.
