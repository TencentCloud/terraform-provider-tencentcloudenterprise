...
sidebar_current: "docs-tencentcloudenterprise-resource-vpc_peer_connect_ex_manager"
description: |-
...
tencentcloudenterprise_vpc_peer_connect_ex_manager can be imported using the id, e.g.
