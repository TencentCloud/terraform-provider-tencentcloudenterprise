...
sidebar_current: "docs-tencentcloudenterprise-resource-turbofs_auto_snapshot_policy_attachment"
description: |-
...
tencentcloudenterprise_turbofs_auto_snapshot_policy_attachment can be imported using the id, e.g.
