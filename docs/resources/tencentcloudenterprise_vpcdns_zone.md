...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_vpcdns_zone"
sidebar_current: "docs-tencentcloudenterprise-resource-vpcdns_zone"
description: |-
  Provide a resource to create a Private Dns Zone.
---

# tencentcloudenterprise_vpcdns_zone
...
tencentcloudenterprise_vpcdns_zone can be imported using the id, e.g.
