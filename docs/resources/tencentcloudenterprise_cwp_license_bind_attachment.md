...
sidebar_current: "docs-tencentcloudenterprise-resources-cwp_license_bind_attachment"
description: |-
...
resource "tencentcloudenterprise_cwp_license_bind_attachment" "example" {
  resource_id  = tencentcloudenterprise_cwp_license_order.example.resource_id
  license_id   = tencentcloudenterprise_cwp_license_order.example.license_id
  license_type = 0
  quuid        = data.tencentcloudenterprise_cwp_machines_simple.example.machines[0].quuid
}
```
...
```
terraform import tencentcloudenterprise_cwp_license_bind_attachment.example cwplic-ab3edffa#44#2c7e5cce-1cec-4456-8d18-018f160dd987#0
```
