...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_turbofs_rule"
sidebar_current: "docs-tencentcloudenterprise-resources-turbofs_rule"
description: |-
  Provides a resource to create a TurboFS permission group rule.
---

# tencentcloudenterprise_turbofs_rule
