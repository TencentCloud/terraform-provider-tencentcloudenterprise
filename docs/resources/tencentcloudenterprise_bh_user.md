...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_bh_user"
sidebar_current: "docs-tencentcloudenterprise-resource-bh_user"
description: |-
  Provide a resource to create a BH user
---

# tencentcloudenterprise_bh_user
...
tencentcloudenterprise_bh_user can be imported using the id, e.g.
