...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cls_cos_recharge"
sidebar_current: "docs-tencentcloudenterprise-resource-cls_cos_recharge"
description: |-
  Provides a resource to create a cls cos_recharge
---

# tencentcloudenterprise_cls_cos_recharge
...
* `metadata` - (Optional, List: [`String`]) Metadata. Supported: bucket, object.
* `prefix` - (Optional, String) Cos file prefix.
* `task_type` - (Optional, Int) Cos recharge task type. 1: one-time import, 2: continuous import.
...
tencentcloudenterprise_cls_cos_recharge can be imported using the id, e.g.
