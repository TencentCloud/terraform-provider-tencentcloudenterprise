...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cam_policy"
sidebar_current: "docs-tencentcloudenterprise-resource-cam_policy"
description: |-
  Provides a resource to create a CAM policy.
---

# tencentcloudenterprise_cam_policy
...
* `name` - (Required, String) Name of CAM policy.
...
tencentcloudenterprise_cam_policy can be imported using the id, e.g.
