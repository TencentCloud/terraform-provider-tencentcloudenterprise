...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_tdmq_subscription_attachment"
sidebar_current: "docs-tencentcloudenterprise-resource-tdmq_subscription_attachment"
description: |-
  Provides a resource to create a tdmq subscription_attachment
---

# tencentcloudenterprise_tdmq_subscription_attachment
...
tencentcloudenterprise_tdmq_subscription_attachment can be imported using the id, e.g.
