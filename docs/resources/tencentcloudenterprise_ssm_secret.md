...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_ssm_secret"
sidebar_current: "docs-tencentcloudenterprise-resource-ssm_secret"
description: |-
  Provide a resource to create a SSM secret.
---

# tencentcloudenterprise_ssm_secret
...
tencentcloudenterprise_ssm_secret can be imported using the id, e.g.
