...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_vpn_gateway"
sidebar_current: "docs-tencentcloudenterprise-resources-vpn_gateway"
description: |-
  Provides a resource to create a VPN gateway.
---

# tencentcloudenterprise_vpn_gateway
