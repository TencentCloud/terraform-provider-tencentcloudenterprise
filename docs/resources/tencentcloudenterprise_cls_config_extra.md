...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cls_config_extra"
sidebar_current: "docs-tencentcloudenterprise-resources-cls_config_extra"
description: |-
  Provides a resource to create a cls config extra
---

# tencentcloudenterprise_cls_config_extra
