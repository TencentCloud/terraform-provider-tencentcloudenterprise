...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_tcr_token"
sidebar_current: "docs-tencentcloudenterprise-resource-tcr_token"
description: |-
  Use this resource to create tcr long term token.
---

# tencentcloudenterprise_tcr_token
...
tencentcloudenterprise_tcr_token can be imported using the id, e.g.
