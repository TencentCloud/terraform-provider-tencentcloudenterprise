...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_vpc_classic_link_attachment"
sidebar_current: "docs-tencentcloudenterprise-resource-vpc_classic_link_attachment"
description: |-
  Provides a resource to create a vpc classic_link_attachment
---

# tencentcloudenterprise_vpc_classic_link_attachment
...
tencentcloudenterprise_vpc_classic_link_attachment can be imported using the id, e.g.
