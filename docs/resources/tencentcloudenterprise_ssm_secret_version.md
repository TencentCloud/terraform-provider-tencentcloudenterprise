...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_ssm_secret_version"
sidebar_current: "docs-tencentcloudenterprise-resource-ssm_secret_version"
description: |-
  Provide a resource to create a SSM secret version.
---

# tencentcloudenterprise_ssm_secret_version
...
tencentcloudenterprise_ssm_secret_version can be imported using the id, e.g.
