...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cfw_vpc_policy"
sidebar_current: "docs-tencentcloudenterprise-resource-cfw_vpc_policy"
description: |-
  Provides a resource to create a cloud firewall (cfw) vpc policy.
---

# tencentcloudenterprise_cfw_vpc_policy
...
tencentcloudenterprise_cfw_vpc_policy can be imported using the id, e.g.
