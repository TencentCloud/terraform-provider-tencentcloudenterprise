...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_mariadb_hour_db_instance"
sidebar_current: "docs-tencentcloudenterprise-resources-mariadb_hour_db_instance"
description: |-
  Provides a resource to create a mariadb hour_db_instance
---

# tencentcloudenterprise_mariadb_hour_db_instance
...
```hcl
resource "tencentcloudenterprise_mariadb_hour_db_instance" "basic" {
  db_version_id = "10.0"
...
```
$ terraform import tencentcloudenterprise_mariadb_hour_db_instance.hour_db_instance tdsql-kjqih9nn
```
