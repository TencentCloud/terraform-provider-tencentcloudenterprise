...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cfw_nat_policy"
sidebar_current: "docs-tencentcloudenterprise-resource-cfw_nat_policy"
description: |-
  Provides a resource to create a cloud firewall (cfw) NAT policy.
---

# tencentcloudenterprise_cfw_nat_policy
...
* `direction` - (Required, Int) Rule direction: 1 for inbound rule, 0 for outbound rule.
...
tencentcloudenterprise_cfw_nat_policy can be imported using the id, e.g.
