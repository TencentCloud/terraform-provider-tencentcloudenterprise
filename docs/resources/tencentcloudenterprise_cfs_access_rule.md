...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cfs_access_rule"
sidebar_current: "docs-tencentcloudenterprise-resources-cfs_access_rule"
description: |-
  Provides a resource to create a CFS access rule.
---

# tencentcloudenterprise_cfs_access_rule
