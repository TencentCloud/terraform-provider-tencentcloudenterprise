...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_brc_backup_cfs"
sidebar_current: "docs-tencentcloudenterprise-resource-brc_backup_cfs"
description: |-
  Provides a resource to create a brc cfs backup
---

# tencentcloudenterprise_brc_backup_cfs
...
tencentcloudenterprise_brc_backup_cfs can be imported using the id, e.g.
