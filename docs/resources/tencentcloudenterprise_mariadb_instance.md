...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_mariadb_instance"
sidebar_current: "docs-tencentcloudenterprise-resources-mariadb_instance"
description: |-
  Provides a resource to create a mariadb instance
---

# tencentcloudenterprise_mariadb_instance
...
```hcl
resource "tencentcloudenterprise_mariadb_instance" "instance" {
...
mariadb tencentcloudenterprise_mariadb_instance can be imported using the id, e.g.
```
$ terraform import tencentcloudenterprise_mariadb_instance.instance tdsql-4pzs5b67
```
