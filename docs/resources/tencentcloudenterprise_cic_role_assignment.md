...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cic_role_assignment"
sidebar_current: "docs-tencentcloudenterprise-resource-cic_role_assignment"
description: |-
...
tencentcloudenterprise_cic_role_assignment can be imported using the id, e.g.
