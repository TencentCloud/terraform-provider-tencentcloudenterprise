...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_dasb_acl"
sidebar_current: "docs-tencentcloudenterprise-resource-dasb_acl"
description: |-
  Provide a resource to create a DASB ACL
---

# tencentcloudenterprise_dasb_acl
...
tencentcloudenterprise_dasb_acl can be imported using the id, e.g.
