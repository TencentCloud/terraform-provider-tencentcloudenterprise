...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_tcr_service_account"
sidebar_current: "docs-tencentcloudenterprise-resource-tcr_service_account"
description: |-
  Provides a resource to create a tcr service account.
---

# tencentcloudenterprise_tcr_service_account
...
tencentcloudenterprise_tcr_service_account can be imported using the id, e.g.
