...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_turbofs_file_system"
sidebar_current: "docs-tencentcloudenterprise-resource-turbofs_file_system"
description: |-
  Provides a resource to create a parallel file system(TurboFS).
---

# tencentcloudenterprise_turbofs_file_system
...
tencentcloudenterprise_turbofs_file_system can be imported using the id, e.g.
