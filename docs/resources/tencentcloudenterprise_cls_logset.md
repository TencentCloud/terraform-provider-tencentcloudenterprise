...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cls_logset"
sidebar_current: "docs-tencentcloudenterprise-resource-cls_logset"
description: |-
  Provides a resource to create a cls logset
---

# tencentcloudenterprise_cls_logset
...
tencentcloudenterprise_cls_logset can be imported using the id, e.g.
