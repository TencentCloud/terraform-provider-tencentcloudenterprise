...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_tdmq_topic"
sidebar_current: "docs-tencentcloudenterprise-resource-tdmq_topic"
description: |-
  Provide a resource to create a TDMQ topic.
---

# tencentcloudenterprise_tdmq_topic
...
tencentcloudenterprise_tdmq_topic can be imported using the id, e.g.
