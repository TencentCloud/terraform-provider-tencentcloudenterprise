...
sidebar_current: "docs-tencentcloudenterprise-resource-cls_config_attachment"
description: |-
...
tencentcloudenterprise_cls_config_attachment can be imported using the id, e.g.
