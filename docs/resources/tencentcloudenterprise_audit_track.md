...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_audit_track"
sidebar_current: "docs-tencentcloudenterprise-resource-audit_track"
description: |-
  Provides a resource to create a audit track
---

# tencentcloudenterprise_audit_track
...
tencentcloudenterprise_audit_track can be imported using the id, e.g.
