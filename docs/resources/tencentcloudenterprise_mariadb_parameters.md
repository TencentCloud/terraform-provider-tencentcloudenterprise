...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_mariadb_parameters"
sidebar_current: "docs-tencentcloudenterprise-resources-mariadb_parameters"
description: |-
  Provides a resource to create a mariadb parameters
---

# tencentcloudenterprise_mariadb_parameters
...
```hcl
resource "tencentcloudenterprise_mariadb_parameters" "parameters" {
...
```
$ terraform import tencentcloudenterprise_mariadb_parameters.parameters tdsql-4pzs5b67
```
