...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cls_config"
sidebar_current: "docs-tencentcloudenterprise-resource-cls_config"
description: |-
  Provides a resource to create a cls config
---

# tencentcloudenterprise_cls_config
...
* `input_type` - (Optional, String) Log input type. Supported values: file, window_event, syslog, k8s_stdout, k8s_file.
...
tencentcloudenterprise_cls_config can be imported using the id, e.g.
