...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_clb_listener"
sidebar_current: "docs-tencentcloudenterprise-resource-clb_listener"
description: |-
...
* `sni_switch` - (Optional, Bool, ForceNew) Indicates whether SNI is enabled, and only supported with protocol `HTTPS`. If enabled, you can set a certificate for each rule in `tencentcloudenterprise_clb_listener_rule`, otherwise all rules have a certificate.
...
tencentcloudenterprise_clb_listener can be imported using the id, e.g.
