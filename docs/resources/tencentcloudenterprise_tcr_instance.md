...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_tcr_instance"
sidebar_current: "docs-tencentcloudenterprise-resource-tcr_instance"
description: |-
  Use this resource to create tcr instance.
---

# tencentcloudenterprise_tcr_instance
...
* `replications` - (Optional, List) Specify List of instance Replications, premium only.
...
tencentcloudenterprise_tcr_instance can be imported using the id, e.g.
