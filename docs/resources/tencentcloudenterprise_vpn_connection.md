...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_vpn_connection"
sidebar_current: "docs-tencentcloudenterprise-resources-vpn_connection"
description: |-
  Provides a resource to create a VPN connection.
---

# tencentcloudenterprise_vpn_connection
