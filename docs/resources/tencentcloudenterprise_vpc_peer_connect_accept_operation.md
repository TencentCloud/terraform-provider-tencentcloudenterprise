...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_vpc_peer_connect_accept_operation"
sidebar_current: "docs-tencentcloudenterprise-resource-vpc_peer_connect_accept_operation"
description: |-
  Provides a resource to accept a same-region cross-account VPC peering connection.
---

# tencentcloudenterprise_vpc_peer_connect_accept_operation
