...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_vpc_peer_ip_translation_nat_rule"
sidebar_current: "docs-tencentcloudenterprise-resource-vpc_peer_ip_translation_nat_rule"
description: |-
  Provides a resource to creating VPC peer IP translation NAT rule.
---

# tencentcloudenterprise_vpc_peer_ip_translation_nat_rule
...
* `description` - (Optional, String) Description of the peer IP translation NAT rule.
...
tencentcloudenterprise_vpc_peer_ip_translation_nat_rule can be imported using the id, e.g.
