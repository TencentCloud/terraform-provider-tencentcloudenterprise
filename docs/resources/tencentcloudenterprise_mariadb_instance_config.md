...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_mariadb_instance_config"
sidebar_current: "docs-tencentcloudenterprise-resources-mariadb_instance_config"
description: |-
  Provides a resource to create a mariadb instance_config
---

# tencentcloudenterprise_mariadb_instance_config
...
```hcl
resource "tencentcloudenterprise_mariadb_instance_config" "test" {
...
```
terraform import tencentcloudenterprise_mariadb_instance_config.test id
```
