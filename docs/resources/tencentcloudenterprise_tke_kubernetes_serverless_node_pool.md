...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_tke_kubernetes_serverless_node_pool"
sidebar_current: "docs-tencentcloudenterprise-resources-tke_kubernetes_serverless_node_pool"
description: |-
  Provide a resource to create serverless node pool of cluster.
---

# tencentcloudenterprise_tke_kubernetes_serverless_node_pool
...
resource "tencentcloudenterprise_kubernetes_serverless_node_pool" "example_serverless_node_pool" {
  cluster_id = tencentcloudenterprise_kubernetes_cluster.example.id
