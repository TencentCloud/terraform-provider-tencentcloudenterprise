...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_ngwaf_custom_rule"
sidebar_current: "docs-tencentcloudenterprise-resource-ngwaf_custom_rule"
description: |-
  Provides a resource to create a NGWAF custom rule.
---

# tencentcloudenterprise_ngwaf_custom_rule
...
* `logical_op` - (Optional, String) Logical relation between strategies, can be 'and' or 'or'.
...
tencentcloudenterprise_ngwaf_custom_rule can be imported using the id, e.g.
