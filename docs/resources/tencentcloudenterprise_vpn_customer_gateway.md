...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_vpn_customer_gateway"
sidebar_current: "docs-tencentcloudenterprise-resources-vpn_customer_gateway"
description: |-
  Provides a resource to create a VPN customer gateway.
---

# tencentcloudenterprise_vpn_customer_gateway
