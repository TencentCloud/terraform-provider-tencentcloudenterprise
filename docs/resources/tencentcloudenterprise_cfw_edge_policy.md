...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cfw_edge_policy"
sidebar_current: "docs-tencentcloudenterprise-resource-cfw_edge_policy"
description: |-
  Provides a resource to create a cloud firewall (cfw) edge policy.
---

# tencentcloudenterprise_cfw_edge_policy
...
tencentcloudenterprise_cfw_edge_policy can be imported using the id, e.g.
