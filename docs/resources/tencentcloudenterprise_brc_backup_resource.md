...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_brc_backup_resource"
sidebar_current: "docs-tencentcloudenterprise-resource-brc_backup_resource"
description: |-
  Provides a resource to create a brc resource backup
---

# tencentcloudenterprise_brc_backup_resource
...
tencentcloudenterprise_brc_backup_resource can be imported using the id, e.g.
