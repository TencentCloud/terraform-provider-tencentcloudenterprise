...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_turbofs_auto_snapshot_policy"
sidebar_current: "docs-tencentcloudenterprise-resource-turbofs_auto_snapshot_policy"
description: |-
  Provides a resource to create a turbofs auto_snapshot_policy
---

# tencentcloudenterprise_turbofs_auto_snapshot_policy
...
tencentcloudenterprise_turbofs_auto_snapshot_policy can be imported using the id, e.g.
