...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_mariadb_account_privileges"
sidebar_current: "docs-tencentcloudenterprise-resources-mariadb_account_privileges"
description: |-
  Provides a resource to create a mariadb account_privileges
---

# tencentcloudenterprise_mariadb_account_privileges
...
```hcl
resource "tencentcloudenterprise_mariadb_account_privileges" "account_privileges" {
...
```
terraform import tencentcloudenterprise_mariadb_account_privileges.account_privileges account_privileges_id
```
