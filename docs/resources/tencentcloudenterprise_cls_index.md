...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cls_index"
sidebar_current: "docs-tencentcloudenterprise-resource-cls_index"
description: |-
  Provides a resource to create a cls index.
---

# tencentcloudenterprise_cls_index
...
tencentcloudenterprise_cls_index can be imported using the id, e.g.
