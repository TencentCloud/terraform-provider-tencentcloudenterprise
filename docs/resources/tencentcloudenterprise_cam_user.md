...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cam_user"
sidebar_current: "docs-tencentcloudenterprise-resource-cam_user"
description: |-
  Provides a resource to manage CAM user.
---

# tencentcloudenterprise_cam_user
...
tencentcloudenterprise_cam_user can be imported using the id, e.g.
