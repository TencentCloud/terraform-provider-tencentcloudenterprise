...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_organization_org_member"
sidebar_current: "docs-tencentcloudenterprise-resource-organization_org_member"
description: |-
  Provides a resource to create a organization org_member
---

# tencentcloudenterprise_organization_org_member
...
tencentcloudenterprise_organization_org_member can be imported using the id, e.g.
