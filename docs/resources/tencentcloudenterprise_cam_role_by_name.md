...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cam_role_by_name"
sidebar_current: "docs-tencentcloudenterprise-resource-cam_role_by_name"
description: |-
  Provides a resource to create a CAM role.
---

# tencentcloudenterprise_cam_role_by_name
...
tencentcloudenterprise_cam_role_by_name can be imported using the id, e.g.
