...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cic_user_sync_provisioning"
sidebar_current: "docs-tencentcloudenterprise-resource-cic_user_sync_provisioning"
description: |-
...
* `target_type` - (Optional, String) Type of the synchronized target account of the Tencent Cloud Cic. ManagerUin: admin account; MemberUin: member account.
* `target_uin` - (Optional, Int) UIN of the synchronized target account of the Tencent Cloud Cic.
...
tencentcloudenterprise_cic_user_sync_provisioning can be imported using the id, e.g.
