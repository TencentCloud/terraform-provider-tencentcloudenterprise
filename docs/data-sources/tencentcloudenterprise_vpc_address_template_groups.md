...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_vpc_address_template_groups"
sidebar_current: "docs-tencentcloudenterprise-datasource-vpc_address_template_groups"
description: |-
...
```hcl
data "tencentcloudenterprise_vpc_address_template_groups" "name" {
  name = "test"
}
```
