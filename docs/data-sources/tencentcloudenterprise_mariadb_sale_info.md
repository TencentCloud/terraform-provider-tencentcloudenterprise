...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_mariadb_sale_info"
sidebar_current: "docs-tencentcloudenterprise-datasource-mariadb_sale_info"
description: |-
  Use this data source to query detailed information of mariadb sale_info
---

# tencentcloudenterprise_mariadb_sale_info
...
```hcl
data "tencentcloudenterprise_mariadb_sale_info" "sale_info" {
}
```
