...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_mariadb_instance_specs"
sidebar_current: "docs-tencentcloudenterprise-datasource-mariadb_instance_specs"
description: |-
  Use this data source to query detailed information of mariadb instance_specs
---

# tencentcloudenterprise_mariadb_instance_specs
...
```hcl
data "tencentcloudenterprise_mariadb_instance_specs" "instance_specs" {
}
```
