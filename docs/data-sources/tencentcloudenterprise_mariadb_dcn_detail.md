...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_mariadb_dcn_detail"
sidebar_current: "docs-tencentcloudenterprise-datasource-mariadb_dcn_detail"
description: |-
  Use this data source to query detailed information of mariadb dcn_detail
---

# tencentcloudenterprise_mariadb_dcn_detail
...
```hcl
data "tencentcloudenterprise_mariadb_dcn_detail" "dcn_detail" {
