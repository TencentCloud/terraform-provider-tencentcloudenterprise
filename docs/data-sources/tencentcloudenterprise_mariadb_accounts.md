...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_mariadb_accounts"
sidebar_current: "docs-tencentcloudenterprise-datasource-mariadb_accounts"
description: |-
  Use this data source to query detailed information of mariadb accounts
---

# tencentcloudenterprise_mariadb_accounts
...
```hcl
data "tencentcloudenterprise_mariadb_accounts" "accounts" {
