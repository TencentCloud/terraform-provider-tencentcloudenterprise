...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_mariadb_slow_logs"
sidebar_current: "docs-tencentcloudenterprise-datasource-mariadb_slow_logs"
description: |-
  Use this data source to query detailed information of mariadb slow_logs
---

# tencentcloudenterprise_mariadb_slow_logs
...
```hcl
data "tencentcloudenterprise_mariadb_slow_logs" "slow_logs" {
