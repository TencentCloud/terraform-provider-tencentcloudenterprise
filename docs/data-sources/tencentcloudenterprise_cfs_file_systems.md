...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cfs_file_systems"
sidebar_current: "docs-tencentcloudenterprise-datasource-cfs_file_systems"
description: |-
  Use this data source to query the detail information of cloud file systems(CFS).
---

# tencentcloudenterprise_cfs_file_systems
