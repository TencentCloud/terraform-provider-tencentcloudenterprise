...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cam_user_policy_attachments"
sidebar_current: "docs-tencentcloudenterprise-datasource-cam_user_policy_attachments"
description: |-
  Use this data source to query detailed information of CAM user policy attachments
---

# tencentcloudenterprise_cam_user_policy_attachments
