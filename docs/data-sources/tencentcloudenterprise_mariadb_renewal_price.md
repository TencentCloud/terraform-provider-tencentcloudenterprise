...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_mariadb_renewal_price"
sidebar_current: "docs-tencentcloudenterprise-datasource-mariadb_renewal_price"
description: |-
  Use this data source to query detailed information of mariadb renewal_price
---

# tencentcloudenterprise_mariadb_renewal_price
...
```hcl
data "tencentcloudenterprise_mariadb_renewal_price" "renewal_price" {
