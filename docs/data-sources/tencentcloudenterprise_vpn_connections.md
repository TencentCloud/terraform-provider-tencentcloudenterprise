...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_vpn_connections"
sidebar_current: "docs-tencentcloudenterprise-datasource-vpn_connections"
description: |-
  Use this data source to query detailed information of VPN connections.
---

# tencentcloudenterprise_vpn_connections
...
```hcl
data "tencentcloudenterprise_vpn_connections" "foo" {
  name                = "main"
  id                  = "vpnx-xfqag"
