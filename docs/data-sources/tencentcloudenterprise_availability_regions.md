...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_availability_regions"
sidebar_current: "docs-tencentcloudenterprise-datasource-availability_regions"
description: |-
...
```hcl
data "tencentcloudenterprise_availability_regions" "my_favourite_region" {
  name = "ap-guangzhou"
}
```
