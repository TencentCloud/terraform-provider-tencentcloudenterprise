...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_mariadb_upgrade_price"
sidebar_current: "docs-tencentcloudenterprise-datasource-mariadb_upgrade_price"
description: |-
  Use this data source to query detailed information of mariadb upgrade_price
---

# tencentcloudenterprise_mariadb_upgrade_price
...
```hcl
data "tencentcloudenterprise_mariadb_upgrade_price" "upgrade_price" {
