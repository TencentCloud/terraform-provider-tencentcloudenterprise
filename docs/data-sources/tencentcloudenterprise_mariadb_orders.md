...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_mariadb_orders"
sidebar_current: "docs-tencentcloudenterprise-datasource-mariadb_orders"
description: |-
  Use this data source to query detailed information of mariadb orders
---

# tencentcloudenterprise_mariadb_orders
...
```hcl
data "tencentcloudenterprise_mariadb_orders" "orders" {
