...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_mariadb_project_security_groups"
sidebar_current: "docs-tencentcloudenterprise-datasource-mariadb_project_security_groups"
description: |-
  Use this data source to query detailed information of mariadb project_security_groups
---

# tencentcloudenterprise_mariadb_project_security_groups
...
```hcl
data "tencentcloudenterprise_mariadb_project_security_groups" "project_security_groups" {
  product    = "mariadb"
  project_id = 0
}
```
