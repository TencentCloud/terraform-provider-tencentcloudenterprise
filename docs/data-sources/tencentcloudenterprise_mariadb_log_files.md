...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_mariadb_log_files"
sidebar_current: "docs-tencentcloudenterprise-datasource-mariadb_log_files"
description: |-
  Use this data source to query detailed information of mariadb log_files
---

# tencentcloudenterprise_mariadb_log_files
...
```hcl
data "tencentcloudenterprise_mariadb_log_files" "log_files" {
