...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_mariadb_price"
sidebar_current: "docs-tencentcloudenterprise-datasource-mariadb_price"
description: |-
  Use this data source to query detailed information of mariadb price
---

# tencentcloudenterprise_mariadb_price
...
```hcl
data "tencentcloudenterprise_mariadb_price" "price" {
  zone       = "ap-guangzhou-3"
  node_count = 2
  memory     = 2
  storage    = 20
