...
page_title: "TencentCloudEnterprise: tencentcloudenterprise_cfs_access_rules"
sidebar_current: "docs-tencentcloudenterprise-datasource-cfs_access_rules"
description: |-
  Use this data source to query the detail information of CFS access rule.
---

# tencentcloudenterprise_cfs_access_rules
