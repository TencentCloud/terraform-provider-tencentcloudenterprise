...
//
// func init() {
// 	// go test -v ./tencentcloud -sweep=ap-shanghai -sweep-run=tencentcloudenterprise_tcr_token
// 	resource.AddTestSweepers("tencentcloudenterprise_tcr_token", &resource.Sweeper{
// 		Name: "tencentcloudenterprise_tcr_token",
...
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_token.mytcr_token", "description", "test token"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_token.mytcr_token", "enable", "true"),
// 					resource.TestCheckResourceAttrSet("tencentcloudenterprise_tcr_token.mytcr_token", "token_id"),
// 					resource.TestCheckResourceAttrSet("tencentcloudenterprise_tcr_token.mytcr_token", "create_time"),
// 					resource.TestCheckResourceAttrSet("tencentcloudenterprise_tcr_token.mytcr_token", "token"),
// 					resource.TestCheckResourceAttrSet("tencentcloudenterprise_tcr_token.mytcr_token", "user_name"),
// 				),
// 				Destroy: false,
// 			},
// 			{
// 				ResourceName:            "tencentcloudenterprise_tcr_token.mytcr_token",
// 				ImportState:             true,
...
// 				},
// 				Check: resource.ComposeAggregateTestCheckFunc(
// 					testAccCheckTCRTokenExists("tencentcloudenterprise_tcr_token.mytcr_token"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_token.mytcr_token", "enable", "false"),
// 				),
// 			},
// 		},
// 	})
...
// 		if rs.Type != "tencentcloudenterprise_tcr_token" {
// 			continue
// 		}
...
// resource "tencentcloudenterprise_tcr_token" "mytcr_token" {
