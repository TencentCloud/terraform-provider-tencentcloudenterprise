...
func init() {
	registerResourceDescriptionProvider("tencentcloudenterprise_tcr_immutable_tag_rule", CNDescription{
		TerraformTypeCN: "TCR镜像版本不可变规则",
		DescriptionCN:   "提供TCR镜像版本不可变规则资源，用于创建和管理容器镜像仓库的镜像版本不可变规则",
...
func resourceTencentCloudTcrImmutableTagRule() *schema.Resource {
	return &schema.Resource{
		...
		Description: "Provides a resource to create and manage TCR immutable tag rule",
...
func resourceTencentCloudTcrImmutableTagRuleCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_immutable_tag_rule.create")()
...
func resourceTencentCloudTcrImmutableTagRuleRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_immutable_tag_rule.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudTcrImmutableTagRuleUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_immutable_tag_rule.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudTcrImmutableTagRuleDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_immutable_tag_rule.delete")()
	defer inconsistentCheck(d, meta)()
