...
func init() {
	registerResourceDescriptionProvider("tencentcloudenterprise_tcr_namespace", CNDescription{
		TerraformTypeCN: "TCR命名空间",
		DescriptionCN:   "提供TCR命名空间资源，用于创建和管理容器镜像仓库的命名空间",
		AttributesCN: map[string]string{
			"instance_id":          "实例ID",
			"name":                 "命名空间名称",
			"is_public":            "是否公开",
			"is_auto_scan":         "是否自动扫描",
			"is_prevent_vul":       "是否阻止漏洞镜像运行",
			"severity":             "漏洞阻断设置中的安全等级",
			"cve_whitelist_items":  "漏洞白名单列表",
		},
	})
}
...
func resourceTencentCloudTcrNamespace() *schema.Resource {
	return &schema.Resource{
		...
		Description: "Provides a resource to create and manage TCR namespace",
...
func resourceTencentCloudTcrNamespaceCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_namespace.create")()
...
func resourceTencentCloudTcrNamespaceUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_namespace.update")()
...
func resourceTencentCloudTcrNamespaceRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_namespace.read")()
...
func resourceTencentCLoudTcrNamespaceDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_namespace.delete")()
