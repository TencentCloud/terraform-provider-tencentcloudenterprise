...
func dataSourceTencentCloudNgwafUserDomains() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudNgwafUserDomainsRead,
...
func dataSourceTencentCloudNgwafUserDomainsRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloudenterprise_ngwaf_user_domains.read")()
	...
	var (
		...
		usersInfo []*ngwaf.UserDomainInfo
	)
