...
```
terraform import tencentcloudenterprise_vpc_dhcp_ip.dhcp_ip dhcp_ip_id
```
*/
...
func resourceTencentCloudVpcDhcpIpCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_dhcp_ip.create")()
...
func resourceTencentCloudVpcDhcpIpRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_dhcp_ip.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudVpcDhcpIpUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_dhcp_ip.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudVpcDhcpIpDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_dhcp_ip.delete")()
	defer inconsistentCheck(d, meta)()
