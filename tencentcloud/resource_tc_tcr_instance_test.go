...
//
// func init() {
// 	// go test -v ./tencentcloud -sweep=ap-shanghai -sweep-run=tencentcloudenterprise_tcr_instance
// 	resource.AddTestSweepers("tencentcloudenterprise_tcr_instance", &resource.Sweeper{
// 		Name: "tencentcloudenterprise_tcr_instance",
...
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "name", "testacctcrinstance1"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "instance_type", "basic"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "tags.test", "test"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "delete_bucket", "true"),
// 					resource.TestCheckResourceAttrSet("tencentcloudenterprise_tcr_instance.mytcr_instance", "internal_end_point"),
// 					resource.TestCheckResourceAttrSet("tencentcloudenterprise_tcr_instance.mytcr_instance", "status"),
// 					resource.TestCheckResourceAttrSet("tencentcloudenterprise_tcr_instance.mytcr_instance", "public_domain"),
// 				),
// 			},
// 			{
// 				ResourceName:            "tencentcloudenterprise_tcr_instance.mytcr_instance",
// 				ImportState:             true,
...
// 				},
// 				Check: resource.ComposeAggregateTestCheckFunc(
// 					testAccCheckTCRInstanceExists("tencentcloudenterprise_tcr_instance.mytcr_instance"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "tags.test", "test"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "delete_bucket", "true"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "open_public_operation", "true"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "security_policy.#", "2"),
// 					// resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "security_policy.0.cidr_block", "192.168.1.1/24"),
// 					// resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "security_policy.1.cidr_block", "10.0.0.1/16"),
// 				),
// 			},
// 			{
...
// 					testAccCheckTCRInstanceExists("tencentcloudenterprise_tcr_instance.mytcr_instance"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "open_public_operation", "true"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "security_policy.#", "1"),
// 					// resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "security_policy.0.cidr_block", "192.168.1.1/24"),
// 				),
// 			},
// 			{
...
// 				Check: resource.ComposeAggregateTestCheckFunc(
// 					testAccCheckTCRInstanceExists("tencentcloudenterprise_tcr_instance.mytcr_instance"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "instance_type", "premium"),
// 				),
// 			},
// 		},
// 	})
...
// 				},
// 				Check: resource.ComposeAggregateTestCheckFunc(
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance_paypaid", "name", "paypaidtcrinstance"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance_paypaid", "instance_type", "basic"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance_paypaid", "tags.test", "test"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance_paypaid", "registry_charge_type", "2"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance_paypaid", "instance_charge_type_prepaid_renew_flag", "1"),
// 					resource.TestCheckResourceAttrSet("tencentcloudenterprise_tcr_instance.mytcr_instance_paypaid", "expired_at"),
// 				),
// 			},
// 			{
// 				ResourceName:            "tencentcloudenterprise_tcr_instance.mytcr_instance_paypaid",
// 				ImportState:             true,
// 				ImportStateVerify:       true,
...
// 				},
// 				Check: resource.ComposeAggregateTestCheckFunc(
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "name", "tfreplicas"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "replications.#", "2"),
// 				),
// 			},
// 			//{
// 			//	ResourceName:            "tencentcloudenterprise_tcr_instance.mytcr_instance",
...
// 				Check: resource.ComposeAggregateTestCheckFunc(
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "name", "tfreplicas"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_instance.mytcr_instance", "replications.#", "3"),
// 				),
// 			},
// 		},
// 	})
...
// 		if rs.Type != "tencentcloudenterprise_tcr_instance" {
// 			continue
// 		}
...
// resource "tencentcloudenterprise_tcr_instance" "mytcr_instance_paypaid" {
