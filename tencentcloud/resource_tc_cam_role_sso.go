...
```hcl
	...
	resource "tencentcloudenterprise_cam_role_sso" "foo" {
		name="test"
...
```
$ terraform import tencentcloudenterprise_cam_role_sso.foo "test"
```
*/
package tencentcloud

func init() {
	registerResourceDescriptionProvider("tencentcloudenterprise_cam_role_sso", CNDescription{
		TerraformTypeCN: "CAM角色SSO配置",
		DescriptionCN:   "提供一个资源来配置 CAM 角色的 SSO（仅支持 OIDC）。",
		AttributesCN: map[string]string{
			"name":         "资源名称",
			"identity_url": "身份提供商 URL",
			"identity_key": "签名公钥",
...
//	defer logElapsed("resource.tencentcloudenterprise_cam_role_sso.create")()
//
...
//	defer logElapsed("resource.tencentcloudenterprise_cam_role_sso.read")()
//
//	logId := getLogId(contextNil)
...
//	defer logElapsed("resource.tencentcloudenterprise_cam_role_sso.update")()
//	logId := getLogId(contextNil)
...
//	defer logElapsed("resource.tencentcloudenterprise_cam_role_sso.delete")()
//	logId := getLogId(contextNil)
