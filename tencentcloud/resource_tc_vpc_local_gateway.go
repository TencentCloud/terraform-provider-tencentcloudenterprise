...
```
terraform import tencentcloudenterprise_vpc_local_gateway.local_gateway local_gateway_id
```
*/
...
func resourceTencentCloudVpcLocalGatewayCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_local_gateway.create")()
...
func resourceTencentCloudVpcLocalGatewayRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_local_gateway.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudVpcLocalGatewayUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_local_gateway.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudVpcLocalGatewayDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_local_gateway.delete")()
	defer inconsistentCheck(d, meta)()
