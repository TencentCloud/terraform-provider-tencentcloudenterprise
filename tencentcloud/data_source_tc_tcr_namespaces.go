...
```hcl
data "tencentcloudenterprise_tcr_namespaces" "name" {
...
func init() {
	registerDataDescriptionProvider("tencentcloudenterprise_tcr_namespaces", CNDescription{
		TerraformTypeCN: "TCR命名空间",
		DescriptionCN:   "提供TCR命名空间数据源，用于查询TCR命名空间的详细信息。",
		AttributesCN: map[string]string{
			"instance_id":        "命名空间所属的实例ID",
			"namespace_name":     "要查询的TCR命名空间名称",
...
func dataSourceTencentCloudTCRNamespaces() *schema.Resource {
	return &schema.Resource{
		...
		Description: "Use this data source to query detailed information of TCR namespaces",
...
func dataSourceTencentCloudTCRNamespacesRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloudenterprise_tcr_namespaces.read")()
