...
```hcl
resource "tencentcloudenterprise_as_start_instances" "start_instances" {
...
func resourceTencentCloudAsStartInstancesCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloudenterprise_as_start_instances.create")()
...
func resourceTencentCloudAsStartInstancesRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_as_start_instances.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudAsStartInstancesDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_as_start_instances.delete")()
	defer inconsistentCheck(d, meta)()
