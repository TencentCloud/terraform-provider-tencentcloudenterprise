...
```
terraform import tencentcloudenterprise_clb_function_targets_attachment.function_targets loadBalancerId#listenerId#locationId or loadBalancerId#listenerId#domain#rule
```
*/
...
func resourceTencentCloudClbFunctionTargetsAttachmentCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_function_targets_attachment.create")()
...
func resourceTencentCloudClbFunctionTargetsAttachmentRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_function_targets_attachment.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudClbFunctionTargetsAttachmentUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_function_targets_attachment.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudClbFunctionTargetsAttachmentDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_function_targets_attachment.delete")()
	defer inconsistentCheck(d, meta)()
