		...
		Steps: []resource.TestStep{
			{
				...
				Check:  resource.ComposeTestCheckFunc(testAccCheckTencentCloudDataSourceID("tencentcloudenterprise_ccn_tenant_instances.tenant_ccn")),
			},
		},
	})
}
...
data "tencentcloudenterprise_ccn_tenant_instances" "tenant_ccn" {
