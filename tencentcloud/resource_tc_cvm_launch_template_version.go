...
```hcl
resource "tencentcloudenterprise_cvm_launch_template_version" "foo" {
  placement {
		zone = "ap-guangzhou-6"
		project_id = 0
...
```
terraform import tencentcloudenterprise_cvm_launch_template_version.launch_template_version ${launch_template_id}#${launch_template_version}
```
*/
...
func resourceTencentCloudCvmLaunchTemplateVersionCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_launch_template_version.create")()
...
func resourceTencentCloudCvmLaunchTemplateVersionRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_launch_template_version.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudCvmLaunchTemplateVersionDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_launch_template_version.delete")()
	defer inconsistentCheck(d, meta)()
