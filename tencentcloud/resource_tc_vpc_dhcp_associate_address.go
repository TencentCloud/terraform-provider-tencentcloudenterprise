...
resource "tencentcloudenterprise_vpc_dhcp_associate_address" "dhcp_associate_address" {
  dhcp_ip_id =  tencentcloudenterprise_vpc_dhcp_ip.dhcp_ip.id
...
```
terraform import tencentcloudenterprise_vpc_dhcp_associate_address.dhcp_associate_address dhcp_associate_address_id
```
*/
...
func resourceTencentCloudVpcDhcpAssociateAddressCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_dhcp_associate_address.create")()
...
func resourceTencentCloudVpcDhcpAssociateAddressRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_dhcp_associate_address.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudVpcDhcpAssociateAddressDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_dhcp_associate_address.delete")()
	defer inconsistentCheck(d, meta)()
