...
```hcl
resource "tencentcloudenterprise_tcr_token" "foo" {
...
```
$ terraform import tencentcloudenterprise_tcr_token.foo cls-cda1iex1#namespace#buv3h3j96j2d1rk1cllg
```
*/
...
func init() {
	registerResourceDescriptionProvider("tencentcloudenterprise_tcr_token", CNDescription{
		TerraformTypeCN: "TCR访问凭证",
		DescriptionCN:   "提供TCR访问凭证资源，用于创建和管理容器镜像仓库的访问令牌",
...
func resourceTencentCloudTcrToken() *schema.Resource {
	return &schema.Resource{
		...
		Description: "Provides a resource to create and manage TCR token",
...
func resourceTencentCloudTcrTokenCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_token.create")()
...
func resourceTencentCloudTcrTokenUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_token.update")()
...
func resourceTencentCloudTcrTokenRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_token.read")()
...
func resourceTencentCLoudTcrTokenDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_token.delete")()
