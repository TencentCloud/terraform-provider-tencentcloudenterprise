...
//
// func init() {
// 	resource.AddTestSweepers("tencentcloudenterprise_tcr_repository", &resource.Sweeper{
// 		Name: "tencentcloudenterprise_tcr_repository",
// 		F:    testSweepTCRRepository,
// 	})
// }
//
// // go test -v ./tencentcloud -sweep=ap-shanghai -sweep-run=tencentcloudenterprise_tcr_repository
...
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_repository.mytcr_repository", "name", "test"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_repository.mytcr_repository", "brief_desc", "111"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_repository.mytcr_repository", "description", "111111111111111111111111111111111111"),
// 					resource.TestCheckResourceAttrSet("tencentcloudenterprise_tcr_repository.mytcr_repository", "create_time"),
// 					resource.TestCheckResourceAttrSet("tencentcloudenterprise_tcr_repository.mytcr_repository", "update_time"),
// 					resource.TestCheckResourceAttrSet("tencentcloudenterprise_tcr_repository.mytcr_repository", "is_public"),
// 				),
// 				Destroy: false,
// 			},
// 			{
// 				ResourceName:      "tencentcloudenterprise_tcr_repository.mytcr_repository",
// 				ImportState:       true,
...
// 				},
// 				Check: resource.ComposeAggregateTestCheckFunc(
// 					testAccCheckTCRRepositoryExists("tencentcloudenterprise_tcr_repository.mytcr_repository"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_repository.mytcr_repository", "brief_desc", "2222"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_repository.mytcr_repository", "description", "211111111111111111111111111111111111"),
// 				),
// 			},
// 		},
// 	})
...
// 		if rs.Type != "tencentcloudenterprise_tcr_repository" {
// 			continue
// 		}
...
//
// resource "tencentcloudenterprise_tcr_repository" "mytcr_repository" {
