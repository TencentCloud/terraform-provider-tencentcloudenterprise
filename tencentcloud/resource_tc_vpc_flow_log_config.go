...
```
terraform import tencentcloudenterprise_vpc_flow_log_config.flow_log_config flow_log_id
```
*/
...
func resourceTencentCloudVpcFlowLogConfigCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_flow_log_config.create")()
...
func resourceTencentCloudVpcFlowLogConfigRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_flow_log_config.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudVpcFlowLogConfigUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_flow_log_config.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudVpcFlowLogConfigDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_flow_log_config.delete")()
	defer inconsistentCheck(d, meta)()
