...
```hcl
resource "tencentcloudenterprise_organization_policy_sub_account_attachment" "policy_sub_account_attachment" {
...
```
$ terraform import tencentcloudenterprise_organization_policy_sub_account_attachment.policy_sub_account_attachment policyId#memberUin#orgSubAccountUin
```
*/
...
func resourceTencentCloudOrganizationPolicySubAccountAttachmentCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_organization_policy_sub_account_attachment.create")()
	...
	if v, _ := d.GetOk("org_sub_account_uin"); v != nil {
		...
		request.OrgSubAccountUins = []*uint64{helper.IntUint64(v.(int))}
	}
...
func resourceTencentCloudOrganizationPolicySubAccountAttachmentRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_organization_policy_sub_account_attachment.read")()
	defer inconsistentCheck(d, meta)()
	...
	// this parameter needs to verify
...
func resourceTencentCloudOrganizationPolicySubAccountAttachmentDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_organization_policy_sub_account_attachment.delete")()
	defer inconsistentCheck(d, meta)()
