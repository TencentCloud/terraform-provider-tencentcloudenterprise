/*
Provides a resource to create an organization org_identity

Example Usage

```hcl
resource "tencentcloudenterprise_organization_org_identity" "org_identity" {
  identity_alias_name = "example_iac_test"
  identity_policy {
    policy_id = 1
...
```
terraform import tencenttencentcloudenterprise_organization_org_identity.org_identity org_identity_id
```
 */
...
func init() {
	registerResourceDescriptionProvider("tencentcloudenterprise_organization_org_identity", CNDescription{
		TerraformTypeCN: "企业组织身份",
		DescriptionCN:   "提供企业组织身份资源，用于创建和管理企业组织身份策略。",
...
func resourceTencentCloudOrganizationOrgIdentity() *schema.Resource {
	return &schema.Resource{
		...
		Description: "Provides a resource to create and manage organization identity for access control",
...
func resourceTencentCloudOrganizationOrgIdentityCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_organization_org_identity.create")()
...
func resourceTencentCloudOrganizationOrgIdentityRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_organization_org_identity.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudOrganizationOrgIdentityUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_organization_org_identity.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudOrganizationOrgIdentityDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_organization_org_identity.delete")()
	defer inconsistentCheck(d, meta)()
