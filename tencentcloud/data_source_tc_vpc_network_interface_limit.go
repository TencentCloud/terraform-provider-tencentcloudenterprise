...
```hcl
data "tencentcloudenterprise_vpc_network_interface_limit" "network_interface_limit" {
...
func dataSourceTencentCloudVpcNetworkInterfaceLimitRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloudenterprise_vpc_network_interface_limit.read")()
