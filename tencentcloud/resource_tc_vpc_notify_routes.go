...
```
terraform import tencentcloudenterprise_vpc_notify_routes.notify_routes notify_routes_id
```
*/
...
func resourceTencentCloudVpcNotifyRoutesCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_notify_routes.create")()
...
func resourceTencentCloudVpcNotifyRoutesRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_notify_routes.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudVpcNotifyRoutesDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_notify_routes.delete")()
	defer inconsistentCheck(d, meta)()
