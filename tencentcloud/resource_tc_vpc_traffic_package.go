...
```
terraform import tencentcloudenterprise_vpc_traffic_package.traffic_package traffic_package_id
```
*/
...
func resourceTencentCloudVpcTrafficPackageCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_traffic_package.create")()
...
func resourceTencentCloudVpcTrafficPackageRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_traffic_package.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudVpcTrafficPackageDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_traffic_package.delete")()
	defer inconsistentCheck(d, meta)()
