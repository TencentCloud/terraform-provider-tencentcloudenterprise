...
```hcl
data "tencentcloudenterprise_tcr_repositories" "name" {
  instance_id       = "tcr-5898if4m"
  namespace_name = "testspace"
}
```
*/
...
func init() {
	registerDataDescriptionProvider("tencentcloudenterprise_tcr_repositories", CNDescription{
		TerraformTypeCN: "TCR仓库",
		DescriptionCN:   "提供TCR仓库数据源，用于查询TCR仓库的详细信息。",
		AttributesCN: map[string]string{
			"instance_id":        "仓库所属的TCR实例ID",
			"namespace_name":     "仓库所属的命名空间名称",
			"repository_name":    "要查询的TCR仓库ID",
...
func dataSourceTencentCloudTCRRepositories() *schema.Resource {
	return &schema.Resource{
		...
		Description: "Use this data source to query detailed information of TCR repositories",
...
func dataSourceTencentCloudTCRRepositoriesRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloudenterprise_tcr_repositories.read")()
