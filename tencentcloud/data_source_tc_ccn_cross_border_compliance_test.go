		...
		Steps: []resource.TestStep{
			{
				...
				Check:  resource.ComposeTestCheckFunc(testAccCheckTencentCloudDataSourceID("data.tencentcloudenterprise_ccn_cross_border_compliance.cross_border_compliance")),
			},
		},
	})
}
...
data "tencentcloudenterprise_ccn_cross_border_compliance" "cross_border_compliance" {
