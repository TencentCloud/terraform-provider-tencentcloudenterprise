...
func init() {
	registerResourceDescriptionProvider("tencentcloudenterprise_cam_role_policy_attachment_by_name", CNDescription{
		TerraformTypeCN: "CAM角色策略名关联",
		DescriptionCN:   "提供一个资源来通过策略名称将策略关联到 CAM 角色。",
		AttributesCN: map[string]string{
			"role_name":   "关联的 CAM 角色名称",
			"policy_name": "策略名称",
			"create_mode": "创建模式",
			"policy_type": "策略类型",
			"create_time": "创建时间",
...
func resourceTencentCloudCamRolePolicyAttachmentByNameCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cam_role_policy_attachment_by_name.create")()
...
func resourceTencentCloudCamRolePolicyAttachmentByNameRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cam_role_policy_attachment_by_name.read")()
...
func resourceTencentCloudCamRolePolicyAttachmentByNameDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cam_role_policy_attachment_by_name.delete")()
