...
```hcl
	...
	data "tencentcloudenterprise_turbofs_file_system_clients" "file_system_clients" {
...
func init() {
	registerDataDescriptionProvider("tencentcloudenterprise_turbofs_file_system_clients", CNDescription{
