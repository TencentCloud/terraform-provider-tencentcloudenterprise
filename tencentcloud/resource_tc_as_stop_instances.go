...
```hcl
resource "tencentcloudenterprise_as_stop_instances" "stop_instances" {
...
func resourceTencentCloudAsStopInstancesCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloudenterprise_as_stop_instances.create")()
...
func resourceTencentCloudAsStopInstancesRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_as_stop_instances.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudAsStopInstancesDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_as_stop_instances.delete")()
	defer inconsistentCheck(d, meta)()
