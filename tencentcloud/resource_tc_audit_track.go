...
```
$ terraform import tencentcloudenterprise_audit_track.track track_id
```
*/
...
func resourceTencentCloudAuditTrackCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_audit_track.create")()
	...
	if v, _ := d.GetOk("track_for_all_members"); v != nil {
		request.TrackForAllMembers = helper.IntInt64(v.(int))
	}
	...
	d.SetId(helper.Int64ToStr(trackId))
...
func resourceTencentCloudAuditTrackRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_audit_track.read")()
	defer inconsistentCheck(d, meta)()
	...
	resp, err := service.DescribeAuditTrackById(ctx, trackId)
	...
	if track.TrackForAllMembers != nil {
		...
		// Backend may omit TrackForAllMembers; default to 0 to keep state stable across import.
		_ = d.Set("track_for_all_members", 0)
	}
...
func resourceTencentCloudAuditTrackUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_audit_track.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudAuditTrackDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_audit_track.delete")()
	defer inconsistentCheck(d, meta)()
