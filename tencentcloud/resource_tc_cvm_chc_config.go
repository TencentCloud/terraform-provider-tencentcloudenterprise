...
```
terraform import tencentcloudenterprise_cvm_chc_config.chc_config chc_config_id
```
*/
...
func resourceTencentCloudCvmChcConfigCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_chc_config.create")()
...
func resourceTencentCloudCvmChcConfigUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_chc_config.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudCvmChcConfigRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_chc_config.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudCvmChcConfigDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_chc_config.delete")()
	defer inconsistentCheck(d, meta)()
