...
```
terraform import tencentcloudenterprise_cfs_user_quota.user_quota fileSystemId#userType#userId
```
*/
...
func resourceTencentCloudCfsUserQuotaCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cfs_user_quota.create")()
...
func resourceTencentCloudCfsUserQuotaRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cfs_user_quota.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudCfsUserQuotaUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cfs_user_quota.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudCfsUserQuotaDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cfs_user_quota.delete")()
	defer inconsistentCheck(d, meta)()
