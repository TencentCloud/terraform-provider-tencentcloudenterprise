...
```hcl
resource "tencentcloudenterprise_reserved_instance" "ri" {
...
```
$ terraform import tencentcloudenterprise_reserved_instance.foo 6cc16e7c-47d7-4fae-9b44-ce5c0f59a920
```
*/
...
func resourceTencentCloudReservedInstanceCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_reserved_instance.create")()
...
func resourceTencentCloudReservedInstanceRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_reserved_instance.read")()
