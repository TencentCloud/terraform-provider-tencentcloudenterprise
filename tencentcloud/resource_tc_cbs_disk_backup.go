...
```
terraform import tencentcloudenterprise_cbs_disk_backup.disk_backup disk_backup_id
```
*/
...
func resourceTencentCloudCbsDiskBackupCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cbs_disk_backup.create")()
...
func resourceTencentCloudCbsDiskBackupRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cbs_disk_backup.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudCbsDiskBackupDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cbs_disk_backup.delete")()
	defer inconsistentCheck(d, meta)()
