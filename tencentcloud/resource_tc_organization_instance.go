/*
Provides a resource to create an organization instance(organization)

Example Usage

```hcl
resource "tencentcloudenterprise_organization_instance" "organization" {
  }
```
...
```
terraform import tencentcloudenterprise_organization_instance.organization organization_id
```
 */
...
func init() {
	registerResourceDescriptionProvider("tencentcloudenterprise_organization_instance", CNDescription{
		TerraformTypeCN: "企业组织实例",
		DescriptionCN:   "提供企业组织实例资源，用于创建和管理企业组织。",
...
func resourceTencentCloudOrganizationOrganization() *schema.Resource {
	return &schema.Resource{
		...
		Description: "Provides a resource to create and manage organization instance",
...
func resourceTencentCloudOrganizationOrganizationCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_organization_instance.create")()
...
func resourceTencentCloudOrganizationOrganizationRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_organization_instance.read")()
	defer inconsistentCheck(d, meta)()
	...
	org, err := service.DescribeOrganizationOrganizationById(ctx)
	if err != nil {
		return err
	}
	...
	if org.NickName != nil {
		_ = d.Set("nick_name", org.NickName)
	}
...
func resourceTencentCloudOrganizationOrganizationUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_organization_instance.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudOrganizationOrganizationDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_organization_instance.delete")()
	defer inconsistentCheck(d, meta)()
