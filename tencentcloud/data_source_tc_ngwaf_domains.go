...
func dataSourceTencentCloudNgwafDomains() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceTencentCloudNgwafDomainsRead,
...
func dataSourceTencentCloudNgwafDomainsRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("data_source.tencentcloudenterprise_ngwaf_domains.read")()
