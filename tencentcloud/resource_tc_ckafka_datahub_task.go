...
//
//```
//terraform import tencentcloudenterprise_ckafka_datahub_task.datahub_task datahub_task_id
//```
//*/
...
//	defer logElapsed("resource.tencentcloudenterprise_ckafka_datahub_task.create")()
...
//	defer logElapsed("resource.tencentcloudenterprise_ckafka_datahub_task.read")()
//	defer inconsistentCheck(d, meta)()
//
//	logId := getLogId(contextNil)
//
...
//	defer logElapsed("resource.tencentcloudenterprise_ckafka_datahub_task.update")()
//	defer inconsistentCheck(d, meta)()
//
//	logId := getLogId(contextNil)
...
//	defer logElapsed("resource.tencentcloudenterprise_ckafka_datahub_task.delete")()
//	defer inconsistentCheck(d, meta)()
//
//	logId := getLogId(contextNil)
//	ctx := context.WithValue(context.TODO(), logIdKey, logId)
