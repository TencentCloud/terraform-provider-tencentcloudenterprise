...
func init() {
	registerResourceDescriptionProvider("tencentcloudenterprise_tcr_repository", CNDescription{
		TerraformTypeCN: "TCR镜像仓库",
		DescriptionCN:   "提供TCR镜像仓库资源，用于创建和管理容器镜像仓库",
...
func resourceTencentCloudTcrRepository() *schema.Resource {
	return &schema.Resource{
		...
		Description: "Provides a resource to create and manage TCR repository",
...
func resourceTencentCloudTcrRepositoryCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_repository.create")()
...
func resourceTencentCloudTcrRepositoryUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_repository.update")()
...
func resourceTencentCloudTcrRepositoryRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_repository.read")()
...
func resourceTencentCLoudTcrRepositoryDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_repository.delete")()
