...
```
terraform import tencentcloudenterprise_cvm_program_fpga_image.program_fpga_image program_fpga_image_id
```
*/
...
func resourceTencentCloudCvmProgramFpgaImageCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_program_fpga_image.create")()
...
func resourceTencentCloudCvmProgramFpgaImageRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_program_fpga_image.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudCvmProgramFpgaImageDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_program_fpga_image.delete")()
	defer inconsistentCheck(d, meta)()
