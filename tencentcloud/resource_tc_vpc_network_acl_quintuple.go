...
```
terraform import tencentcloudenterprise_vpc_network_acl_quintuple.network_acl_quintuple network_acl_quintuple_id
```
*/
...
func resourceTencentCloudVpcNetworkAclQuintupleCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_network_acl_quintuple.create")()
...
func resourceTencentCloudVpcNetworkAclQuintupleRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_network_acl_quintuple.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudVpcNetworkAclQuintupleUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_network_acl_quintuple.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudVpcNetworkAclQuintupleDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_network_acl_quintuple.delete")()
	defer inconsistentCheck(d, meta)()
