		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("tencentcloudenterprise_cbs_disk_backup_rollback_operation.operation", "id"),
					resource.TestCheckResourceAttr("tencentcloudenterprise_cbs_disk_backup_rollback_operation.operation", "is_rollback_completed", "true"),
				),
			},
		},
	})
