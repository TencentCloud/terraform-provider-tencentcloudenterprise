...
```
terraform import tencentcloudenterprise_cvm_launch_template_default_version.launch_template_default_version launch_template_id
```
*/
...
func resourceTencentCloudCvmLaunchTemplateDefaultVersionCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_launch_template_default_version.create")()
...
func resourceTencentCloudCvmLaunchTemplateDefaultVersionRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_launch_template_default_version.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudCvmLaunchTemplateDefaultVersionUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_launch_template_default_version.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudCvmLaunchTemplateDefaultVersionDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_launch_template_default_version.delete")()
	defer inconsistentCheck(d, meta)()
