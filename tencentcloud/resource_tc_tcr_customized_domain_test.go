...
//
// func init() {
// 	resource.AddTestSweepers("tencentcloudenterprise_tcr_customized_domain", &resource.Sweeper{
// 		Name: "tencentcloudenterprise_tcr_customized_domain",
// 		F:    testSweepTcrCustomizedDomain,
// 	})
// }
//
// // go test -v ./tencentcloud -sweep=ap-shanghai -sweep-run=tencentcloudenterprise_tcr_customized_domain
...
// 					resource.TestCheckResourceAttrSet("tencentcloudenterprise_tcr_customized_domain.my_domain", "id"),
// 					resource.TestCheckResourceAttrSet("tencentcloudenterprise_tcr_customized_domain.my_domain", "registry_id"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_customized_domain.my_domain", "domain_name", "www.test.com"),
// 					resource.TestCheckResourceAttr("tencentcloudenterprise_tcr_customized_domain.my_domain", "certificate_id", defaultTCRSSL),
// 				),
// 			},
// 			{
// 				ResourceName:      "tencentcloudenterprise_tcr_customized_domain.my_domain",
// 				ImportState:       true,
