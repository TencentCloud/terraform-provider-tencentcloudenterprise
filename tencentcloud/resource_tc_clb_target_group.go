...
```
$ terraform import tencentcloudenterprise_clb_target_group.test lbtg-3k3io0i0
```
*/
		...
		Schema: map[string]*schema.Schema{
			...
			"target_group_instances": {
				...
				Deprecated: "It has been deprecated from version 1.77.3. " +
					"please use `tencentcloudenterprise_clb_target_group_instance_attachment` instead.",
...
func resourceTencentCloudClbTargetCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_target_group.create")()
...
func resourceTencentCloudClbTargetRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_target_group.read")()
...
func resourceTencentCloudClbTargetUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_target_group.update")()
...
func resourceTencentCloudClbTargetDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_target_group.delete")()
