...
```
terraform import tencentcloudenterprise_vpc_dc_gateway_attachment.dc_gateway_attachment vpcId#dcgId#ngId
```
*/
...
func resourceTencentCloudDcGatewayAttachmentCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_dc_gateway_attachment.create")()
...
func resourceTencentCloudDcGatewayAttachmentRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_dc_gateway_attachment.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudDcGatewayAttachmentDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_dc_gateway_attachment.delete")()
	defer inconsistentCheck(d, meta)()
