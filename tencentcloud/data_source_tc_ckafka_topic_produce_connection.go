...
//
//func init() {
//	registerDataDescriptionProvider("tencentcloudenterprise_ckafka_topic_produce_connection", CNDescription{
...
//	defer logElapsed("data_source.tencentcloudenterprise_ckafka_topic_produce_connection.read")()
