...
```
terraform import tencentcloudenterprise_clb_instance_mix_ip_target_config.instance_mix_ip_target_config instance_id
```
*/
...
func resourceTencentCloudClbInstanceMixIpTargetConfigCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_instance_mix_ip_target_config.create")()
...
func resourceTencentCloudClbInstanceMixIpTargetConfigRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_instance_mix_ip_target_config.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudClbInstanceMixIpTargetConfigUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_instance_mix_ip_target_config.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudClbInstanceMixIpTargetConfigDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_instance_mix_ip_target_config.delete")()
	defer inconsistentCheck(d, meta)()
