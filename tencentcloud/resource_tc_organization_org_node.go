...
func init() {
	registerResourceDescriptionProvider("tencentcloudenterprise_organization_org_node", CNDescription{
		TerraformTypeCN: "企业组织节点",
		DescriptionCN:   "提供企业组织节点资源，用于创建和管理企业组织部门节点。",
...
func resourceTencentCloudOrganizationOrgNode() *schema.Resource {
	return &schema.Resource{
		...
		Description: "Provides a resource to create and manage organization department nodes",
...
func resourceTencentCloudOrganizationOrgNodeCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_organization_org_node.create")()
	...
	if v, _ := d.GetOk("parent_node_id"); v != nil {
		request.ParentNodeId = helper.Int64(int64(v.(int)))
	}
...
func resourceTencentCloudOrganizationOrgNodeRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_organization_org_node.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudOrganizationOrgNodeUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_organization_org_node.update")()
	defer inconsistentCheck(d, meta)()
	...
	request.NodeId = helper.StrToInt64Point(orgNodeId)
...
func resourceTencentCloudOrganizationOrgNodeDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_organization_org_node.delete")()
	defer inconsistentCheck(d, meta)()
