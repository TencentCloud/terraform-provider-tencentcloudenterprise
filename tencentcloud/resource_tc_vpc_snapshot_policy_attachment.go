...
```
terraform import tencentcloudenterprise_vpc_snapshot_policy_attachment.snapshot_policy_attachment snapshot_policy_attachment_id
```
*/
...
func resourceTencentCloudVpcSnapshotPolicyAttachmentCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_snapshot_policy_attachment.create")()
...
func resourceTencentCloudVpcSnapshotPolicyAttachmentRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_snapshot_policy_attachment.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudVpcSnapshotPolicyAttachmentDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_snapshot_policy_attachment.delete")()
	defer inconsistentCheck(d, meta)()
