...
```
terraform import tencentcloudenterprise_vpc_snapshot_policy_config.snapshot_policy_config snapshot_policy_id
```
*/
...
func resourceTencentCloudVpcSnapshotPolicyConfigCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_snapshot_policy_config.create")()
...
func resourceTencentCloudVpcSnapshotPolicyConfigRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_snapshot_policy_config.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudVpcSnapshotPolicyConfigUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_snapshot_policy_config.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudVpcSnapshotPolicyConfigDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_snapshot_policy_config.delete")()
	defer inconsistentCheck(d, meta)()
