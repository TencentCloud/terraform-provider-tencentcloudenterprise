...
```
$ terraform import tencentcloudenterprise_clb_target_group_instance_attachment.test lbtg-3k3io0i0#172.16.48.18#222
```
*/
...
func resourceTencentCloudClbTGAttachmentInstanceCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_target_group_instance_attachment.create")()
...
func resourceTencentCloudClbTGAttachmentInstanceRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_target_group_instance_attachment.read")()
...
func resourceTencentCloudClbTGAttachmentInstanceUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_target_group_instance_attachment.update")()
...
func resourceTencentCloudClbTGAttachmentInstanceDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_target_group_instance_attachment.delete")()
