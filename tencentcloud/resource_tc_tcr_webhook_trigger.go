...
func init() {
	registerResourceDescriptionProvider("tencentcloudenterprise_tcr_webhook_trigger", CNDescription{
		TerraformTypeCN: "TCR Webhook触发器",
		DescriptionCN:   "提供TCR Webhook触发器资源，用于创建和管理容器镜像仓库的Webhook触发器",
...
func resourceTencentCloudTcrWebhookTrigger() *schema.Resource {
	return &schema.Resource{
		...
		Description: "Provides a resource to create and manage TCR webhook trigger",
...
func resourceTencentCloudTcrWebhookTriggerCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_webhook_trigger.create")()
...
func resourceTencentCloudTcrWebhookTriggerRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_webhook_trigger.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudTcrWebhookTriggerUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_webhook_trigger.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudTcrWebhookTriggerDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_webhook_trigger.delete")()
	defer inconsistentCheck(d, meta)()
