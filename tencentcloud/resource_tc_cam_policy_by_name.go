...
```hcl
	...
	resource "tencentcloudenterprise_cam_policy_by_name" "foo" {
...
```
$ terraform import tencentcloudenterprise_cam_policy_by_name.foo name
```
*/
...
func init() {
	registerResourceDescriptionProvider("tencentcloudenterprise_cam_policy_by_name", CNDescription{
		TerraformTypeCN: "CAM策略通过名称",
		DescriptionCN:   "提供 CAM 策略资源，允许通过策略名称来管理自定义策略。",
...
func resourceTencentCloudCamPolicyByNameCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cam_policy_by_name.create")()
...
func resourceTencentCloudCamPolicyByNameRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cam_policy_by_name.read")()
...
func resourceTencentCloudCamPolicyByNameUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cam_policy_by_name.update")()
	...
	// First, get the policy ID by name
	var policies []*cam.StrategyInfo
	params := make(map[string]interface{})
	params["name"] = policyName
	err := resource.Retry(readRetryTimeout, func() *resource.RetryError {
	...
	if d.HasChange("name") {
		...
		request.PolicyName = helper.String(newName)
		changeFlag = true
	}
...
func resourceTencentCloudCamPolicyByNameDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cam_policy_by_name.delete")()
