...
func init() {
	registerResourceDescriptionProvider("tencentcloudenterprise_ccn", CNDescription{
		TerraformTypeCN: "云联网",
		DescriptionCN:   "用于创建和管理云联网实例。",
...
func resourceTencentCloudCcnCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_ccn.create")()
...
func resourceTencentCloudCcnRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_ccn.read")()
...
func resourceTencentCloudCcnUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_ccn.update")()
...
func resourceTencentCloudCcnDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_ccn.delete")()
