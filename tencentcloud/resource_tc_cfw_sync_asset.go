/*
Provides a resource to trigger cloud firewall (cfw) asset synchronization.

Example Usage

```hcl

resource "tencentcloudenterprise_cfw_sync_asset" "example" {
}
...
func resourceTencentCloudCfwSyncAssetCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cfw_sync_asset.create")()
...
func resourceTencentCloudCfwSyncAssetRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cfw_sync_asset.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudCfwSyncAssetDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cfw_sync_asset.delete")()
	defer inconsistentCheck(d, meta)()
...
func init() {
	registerResourceDescriptionProvider("tencentcloudenterprise_cfw_sync_asset", CNDescription{
		TerraformTypeCN: "资产同步",
		DescriptionCN:   "提供云防火墙资产同步资源，用于触发云防火墙资产同步操作。",
