		...
		Steps: []resource.TestStep{
			{
				...
				Check:  resource.ComposeTestCheckFunc(resource.TestCheckResourceAttrSet("tencentcloudenterprise_ckafka_consumer_group_modify_offset.consumer_group_modify_offset", "id")),
			},
		},
	})
}
