...
```
terraform import tencentcloudenterprise_as_load_balancer.load_balancer auto_scaling_group_id
```
*/
...
func resourceTencentCloudAsLoadBalancerCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_as_load_balancer.create")()
...
func resourceTencentCloudAsLoadBalancerRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_as_load_balancer.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudAsLoadBalancerUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_as_load_balancer.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudAsLoadBalancerDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_as_load_balancer.delete")()
	defer inconsistentCheck(d, meta)()
