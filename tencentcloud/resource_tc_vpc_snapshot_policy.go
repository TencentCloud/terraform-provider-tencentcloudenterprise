...
```
terraform import tencentcloudenterprise_vpc_snapshot_policy.snapshot_policy snapshot_policy_id
```
*/
...
func resourceTencentCloudVpcSnapshotPolicyCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_snapshot_policy.create")()
...
func resourceTencentCloudVpcSnapshotPolicyRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_snapshot_policy.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudVpcSnapshotPolicyUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_snapshot_policies.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudVpcSnapshotPolicyDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_vpc_snapshot_policy.delete")()
	defer inconsistentCheck(d, meta)()
