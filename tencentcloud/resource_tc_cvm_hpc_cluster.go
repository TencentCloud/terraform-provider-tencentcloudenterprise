...
```
terraform import tencentcloudenterprise_cvm_hpc_cluster.hpc_cluster hpc_cluster_id
```
*/
...
func resourceTencentCloudCvmHpcClusterCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_hpc_cluster.create")()
	...
	if len(response.Response.HpcClusterSet) < 1 {
		return fmt.Errorf("resource `tencentcloudenterprise_cvm_hpc_cluster` create failed.")
	}
...
func resourceTencentCloudCvmHpcClusterRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_hpc_cluster.read")()
	defer inconsistentCheck(d, meta)()
	...
	if hpcCluster == nil {
		d.SetId("")
		return fmt.Errorf("resource `tencentcloudenterprise_cvm_hpc_cluster` %s does not exist", d.Id())
	}
...
func resourceTencentCloudCvmHpcClusterUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_hpc_cluster.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudCvmHpcClusterDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_cvm_hpc_cluster.delete")()
	defer inconsistentCheck(d, meta)()
