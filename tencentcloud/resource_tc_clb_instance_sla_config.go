...
```
terraform import tencentcloudenterprise_clb_instance_sla_config.instance_sla_config instance_id
```
*/
...
func resourceTencentCloudClbInstanceSlaConfigCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_instance_sla_config.create")()
...
func resourceTencentCloudClbInstanceSlaConfigRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_instance_sla_config.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudClbInstanceSlaConfigUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_instance_sla_config.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudClbInstanceSlaConfigDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_clb_instance_sla_config.delete")()
	defer inconsistentCheck(d, meta)()
