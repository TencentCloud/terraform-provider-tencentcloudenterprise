...
func init() {
	registerResourceDescriptionProvider("tencentcloudenterprise_vpc_ccn_bandwidth_limit", CNDescription{
		TerraformTypeCN: "限制CCN带宽",
...
func resourceTencentCloudCcnBandwidthLimit() *schema.Resource {
	return &schema.Resource{
		Description: "Provides a resource to limit CCN bandwidth.",
...
func resourceTencentCloudCcnBandwidthLimitCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_ccn_bandwidth_limit.create")()
...
func resourceTencentCloudCcnBandwidthLimitUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_ccn_bandwidth_limit.update")()
...
func resourceTencentCloudCcnBandwidthLimitRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_ccn_bandwidth_limit.read")()
...
func resourceTencentCloudCcnBandwidthLimitDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_ccn_bandwidth_limit.delete")()
