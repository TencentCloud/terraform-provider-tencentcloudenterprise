...
func init() {
	registerResourceDescriptionProvider("tencentcloudenterprise_tcr_tag_retention_rule", CNDescription{
		TerraformTypeCN: "TCR版本保留规则",
		DescriptionCN:   "提供TCR版本保留规则资源，用于创建和管理容器镜像仓库的版本保留规则",
...
func resourceTencentCloudTcrTagRetentionRule() *schema.Resource {
	return &schema.Resource{
		...
		Description: "Provides a resource to create and manage TCR tag retention rule",
		...
		Schema: map[string]*schema.Schema{
			...
			// retain for tencentcloudenterprise_tcr_tag_retention_executions
			// "retention_id": {
			// 	Computed:    true,
			// 	Type:        schema.TypeString,
...
func resourceTencentCloudTcrTagRetentionRuleCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_tag_retention_rule.create")()
...
func resourceTencentCloudTcrTagRetentionRuleRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_tag_retention_rule.read")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudTcrTagRetentionRuleUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_tag_retention_rule.update")()
	defer inconsistentCheck(d, meta)()
...
func resourceTencentCloudTcrTagRetentionRuleDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_tag_retention_rule.delete")()
	defer inconsistentCheck(d, meta)()
