...
const (
	TCE_PROTECTION_LEVEL = 3
)

//const (
//	PROTECTION_LEVEL_BASIC    = 100
//	PROTECTION_LEVEL_ADVANCED = 200
//	PROTECTION_LEVEL_STRICT   = 300
//)
//
//var PROTECTION_LEVEL = []int{
//	PROTECTION_LEVEL_BASIC,
//	PROTECTION_LEVEL_ADVANCED,
//	PROTECTION_LEVEL_STRICT,
//}

const (
	PEAK_POINTS_METRIC_NAME_ACCESS = "access"
	PEAK_POINTS_METRIC_NAME_CC     = "cc"
	PEAK_POINTS_METRIC_NAME_ATTACK = "attack"
)

var PEAK_POINTS_METRIC_NAMES = []string{
	PEAK_POINTS_METRIC_NAME_ACCESS,
	PEAK_POINTS_METRIC_NAME_CC,
	PEAK_POINTS_METRIC_NAME_ATTACK,
}