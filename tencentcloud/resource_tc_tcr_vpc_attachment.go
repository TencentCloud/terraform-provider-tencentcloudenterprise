...
func init() {
	registerResourceDescriptionProvider("tencentcloudenterprise_tcr_vpc_attachment", CNDescription{
		TerraformTypeCN: "TCR VPC接入",
		DescriptionCN:   "提供TCR VPC接入资源，用于管理容器镜像仓库的VPC内网访问",
		AttributesCN: map[string]string{
			"instance_id":       "实例ID",
			"vpc_id":            "私有网络ID",
			"subnet_id":         "子网ID",
			"enable_public_domain_dns": "是否开启公网域名解析",
			"enable_vpc_domain_dns":    "是否开启VPC域名解析",
			"access_ip":         "内网接入IP",
			"status":            "VPC接入状态",
		},
	})
...
func resourceTencentCloudTcrVpcAttachment() *schema.Resource {
	return &schema.Resource{
		...
		Description: "Provides a resource to create and manage TCR VPC attachment",
...
func resourceTencentCloudTcrVpcAttachmentCreate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_vpc_attachment.create")()
...
func resourceTencentCloudTcrVpcAttachmentRead(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_vpc_attachment.read")()
...
func resourceTencentCloudTcrVpcAttachmentUpdate(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_vpc_attachment.update")()
...
func resourceTencentCLoudTcrVpcAttachmentDelete(d *schema.ResourceData, meta interface{}) error {
	defer logElapsed("resource.tencentcloudenterprise_tcr_vpc_attachment.delete")()
