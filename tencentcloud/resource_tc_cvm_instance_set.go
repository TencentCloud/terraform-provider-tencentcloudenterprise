		...
		Schema: map[string]*schema.Schema{
			...
			*/
			...
			"system_disk_type": {
				...
				Description:  "System disk type. Valid values: `LOCAL_BASIC`: local disk, `LOCAL_SSD`: local SSD disk, `CLOUD_SSD`: SSD, `CLOUD_PREMIUM`: Premium Cloud Storage, `CLOUD_BSSD`: Basic SSD. NOTE: If modified, the instance may force stop.",
			},
			"system_disk_size": {
				Type:         schema.TypeInt,
				Optional:     true,
