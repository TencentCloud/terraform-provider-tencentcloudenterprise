		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCamRolePolicyAttachmentByNameExists("tencentcloudenterprise_cam_role_policy_attachment_by_name.role_policy_attachment_basic"),
					resource.TestCheckResourceAttrSet("tencentcloudenterprise_cam_role_policy_attachment_by_name.role_policy_attachment_basic", "role_name"),
					resource.TestCheckResourceAttrSet("tencentcloudenterprise_cam_role_policy_attachment_by_name.role_policy_attachment_basic", "policy_name"),
				),
			},
			{
				ResourceName:      "tencentcloudenterprise_cam_role_policy_attachment_by_name.role_policy_attachment_basic",
				ImportState:       true,
...
func testAccCheckCamRolePolicyAttachmentByNameDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "tencentcloudenterprise_cam_role_policy_attachment_by_name" {
			continue
		}
...
resource "tencentcloudenterprise_cam_role_policy_attachment_by_name" "role_policy_attachment_basic" {
