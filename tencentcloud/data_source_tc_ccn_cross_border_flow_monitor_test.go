		...
		Steps: []resource.TestStep{
			{
				...
				Check:  resource.ComposeTestCheckFunc(testAccCheckTencentCloudDataSourceID("data.tencentcloudenterprise_ccn_cross_border_flow_monitor.cross_border_flow_monitor")),
			},
		},
	})
}
...
data "tencentcloudenterprise_ccn_cross_border_flow_monitor" "cross_border_flow_monitor" {
